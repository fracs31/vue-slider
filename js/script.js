    ...
    methods: {
        ...
        goRight() {
            ...
            if (index < (this.images.length - 1)) {
                ...
                imgElement.src = this.images[index].image; //cambio l'immagine
                titleElement.innerHTML = this.images[index].title; //cambio il titolo
                textElement.innerHTML = this.images[index].text; //cambio il testo
            } else if (index == (this.images.length - 1)) { //altrimenti se l'indice è uguale alla lunghezza dell'array di immagini
        ...
        goLeft() {
            ...
            if (index > 0) {
                ...
                index = this.images.length - 1; //assegno all'indice il valore della lunghezza dell'array di immagini meno 1
